...
public class Sort implements Iterable<Order>, Serializable {
    ...
    public Sort(Direction direction, List<String> properties) {
        ...
        this.orders = properties.stream().map(p -> new Order(direction, p)).collect(Collectors.toList());
    }
     ...
     */
    public Sort reverse() {
        return new Sort(this.orders.stream()
            .map(o -> o.with(o.isAscending() ? Direction.DESC : Direction.ASC))
    ...
    public static class Order {
        ...
        @Override
        public int hashCode() {
            return Objects.hashCode(direction, property);
        }
