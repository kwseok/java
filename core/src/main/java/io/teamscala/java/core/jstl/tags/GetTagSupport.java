...
public abstract class GetTagSupport extends BodyTagSupport {
	...
	private static final long serialVersionUID = -9180821275472630012L;
	...
	public GetTagSupport() { super(); init(); }
	 ...
	 */
	public void setIgnoreNull(boolean ignoreNull) { this.ignoreNull = ignoreNull; }
