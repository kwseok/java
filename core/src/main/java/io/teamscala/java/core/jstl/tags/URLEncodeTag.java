...
public class URLEncodeTag extends BodyTagSupport {
	...
	public URLEncodeTag() { super(); init(); }
	...
	public int doEndTag() throws JspException {
		...
		try {
			String encodedText = URLEncoder.encode(text, encoding);
			if (var == null)
				pageContext.getOut().write(encodedText);
			else
				pageContext.setAttribute(var, encodedText, scope);
