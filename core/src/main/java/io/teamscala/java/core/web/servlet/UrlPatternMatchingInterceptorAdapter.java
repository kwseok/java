...
public abstract class UrlPatternMatchingInterceptorAdapter implements HandlerInterceptor {
    ...
    public final boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        return !checkUrlPatternsForRequest(request) || preHandleInternal(request, response, handler);
    ...
    public final void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView mav) throws Exception {
        if (checkUrlPatternsForRequest(request)) postHandleInternal(request, response, handler, mav);
    }
    ...
    public final void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        if (checkUrlPatternsForRequest(request)) afterCompletionInternal(request, response, handler, ex);
    }
     ...
     */
    protected Set<String> getAllowedUrlPatterns() {
     ...
     */
    protected Set<String> getDisallowedUrlPatterns() {
        return disallowedUrlPatterns;
    }
