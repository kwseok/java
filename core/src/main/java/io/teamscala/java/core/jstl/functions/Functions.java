...
public class Functions {
	 ...
	 * @return JSON 형식의 문자열
	 */
	public static String toJSON(Object target) { return JSONUtils.toJSONString(target); }
	 ...
	 */
	public static String toJSONAndEscape(Object target) { return JavaScriptUtils.javaScriptEscape(toJSON(target)); }
