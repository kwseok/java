...
public class Expr<T> {
    ...
    public Expr() { this(Operator.EQ); }
    public Expr(Operator op) { this.op(op); }
    public Expr(MatchMode matchMode) { this.matchMode(matchMode); }
    ...
    public Expr<T> val(T val) { this.val = val; return this; }
    ...
    public MatchMode getMatchMode() { return this.matchMode(); }
    public void setMatchMode(MatchMode matchMode) { this.matchMode(matchMode); }

    public boolean ignoreCase() { return ignoreCase; }
    public Expr<T> ignoreCase(boolean ignoreCase) { this.ignoreCase = ignoreCase; return this; }
    public boolean isIgnoreCase() { return this.ignoreCase(); }
