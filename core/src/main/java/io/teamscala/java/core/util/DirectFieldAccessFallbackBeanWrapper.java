...
public class DirectFieldAccessFallbackBeanWrapper extends BeanWrapperImpl {
    ...
    public DirectFieldAccessFallbackBeanWrapper() {
        super();
    }

    public DirectFieldAccessFallbackBeanWrapper(boolean registerDefaultEditors) {
        super(registerDefaultEditors);
    }

    public DirectFieldAccessFallbackBeanWrapper(Class<?> clazz) {
        super(clazz);
    }

    public DirectFieldAccessFallbackBeanWrapper(Object object) {
        super(object);
    }

    public DirectFieldAccessFallbackBeanWrapper(Object object, String nestedPath, Object rootObject) {
