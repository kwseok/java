...
public class BindDescription implements Serializable {
    ...
    public BindStrategy getStrategy() {
        return bind.strategy();
    }

    public String[] getNestedPaths() {
        return bind.nestedPaths();
    }

    public boolean isPreventDefault() {
        return bind.preventDefault();
    }

    public boolean isPreventDefaultNestedPaths() {
        return bind.preventDefaultNestedPaths();
    }
